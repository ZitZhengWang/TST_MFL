...
def main(config):
    ...
    utils.log(f"FusionMode:{model.fusion_mode}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="configs/metaTrainingOnCUBV4_fusion_ablation.yaml", help="配置文件的路径")
    ...
    # 模型参数
    parser.add_argument('--FusionMode', type=str, default='Manual', help="Conv1d||FC||Manual")
    ...
    config["model_args"]["fusion_mode"] = args.FusionMode
